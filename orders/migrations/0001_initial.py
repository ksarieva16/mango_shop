# Generated by Django 4.0.5 on 2022-07-13 06:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('open', 'Open'), ('in_process', 'In process'), ('canceled', 'Canceled'), ('finished', 'Finished')], default='open', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='OrderItems',
